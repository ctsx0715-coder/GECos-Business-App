    ...
    <>
      ...
      {(goneQuiet || overdue) && (
        <div className="mb-6 space-y-2">
          {goneQuiet && (
            <p className="rounded-xl border border-warning/30 bg-warning-soft px-4 py-3 text-xs text-warning">
          ...
          {overdue && (
            <p className="rounded-xl border border-danger/30 bg-danger-soft px-4 py-3 text-xs text-danger">
