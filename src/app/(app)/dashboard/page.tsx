    ...
    <>
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatTile
          ...
          tone={projects.overBudgetCount > 0 ? "danger" : "default"}
        />
        <StatTile
          icon="clock"
          label="Overdue tasks"
        ...
        <Card className="lg:col-span-2">
          ...
          <div className="px-5 py-4">
            <div className="flex items-baseline gap-2">
              <span className="tabular text-[40px] font-semibold leading-[1.2] tracking-[-0.02em]">
                {compliance.percentValid}%
              </span>
              <span className="text-xs text-muted">valid</span>
            </div>
            <div className="mt-3 flex h-2 gap-0.5 overflow-hidden rounded-full bg-surface-muted">
              <div
      ...
      <Card className="mt-6">
        <CardHeader
          ...
          action={
            <Badge
              ...
              icon={attention.length > 0 ? "clock" : "check"}
            >
        ...
        {attention.length === 0 ? (
          <EmptyState
            ...
            action={<ButtonLink href="/tenders">Open the register</ButtonLink>}
          />
        ) : (
            ...
            {attention.map((item, index) => (
              <li key={`${item.kind}-${index}`}>
                ...
                >
                  ...
                  >
                    <Icon
                      name={item.severity === "danger" ? "alert" : "clock"}
                    />
                  </span>
